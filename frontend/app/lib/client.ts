...
export function Environment(name: string): BaseURL {
    return `https://${name}-the-becoming-backend-shci.encr.app`
}
...
/**
 * Client is an API client for the the-becoming-backend-shci Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "the-becoming-backend-shci-Generated-TS-Client (Encore/v1.46.7)";
        }
